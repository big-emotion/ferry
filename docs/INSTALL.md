...
sed -i.bak "s|@v0.15.0|@${LATEST_SHA}|g" .github/workflows/ferry-*.yml && rm .github/workflows/ferry-*.yml.bak
...
curl -fsSL "https://raw.githubusercontent.com/big-emotion/ferry/v0.15.0/examples/consumer-setup/workflows/ferry-reconcile.yml" \
  -o ".github/workflows/ferry-reconcile.yml"

# Daily cost check — required, runs at 06:00 UTC
curl -fsSL "https://raw.githubusercontent.com/big-emotion/ferry/v0.15.0/examples/consumer-setup/workflows/ferry-cost-daily.yml" \
