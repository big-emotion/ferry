...
sed -i.bak "s|@v0.7.0|@${LATEST_SHA}|g" .github/workflows/ferry-*.yml && rm .github/workflows/ferry-*.yml.bak
...
curl -fsSL "https://raw.githubusercontent.com/big-emotion/ferry/v0.7.0/examples/consumer-setup/workflows/ferry-cost-daily.yml" \
