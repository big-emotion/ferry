...
```bash
LATEST_SHA=$(gh api repos/big-emotion/ferry/git/refs/tags/v0.5.2 --jq '.object.sha')
sed -i.bak "s|@v0.5.2|@${LATEST_SHA}|g" .github/workflows/ferry-*.yml && rm .github/workflows/ferry-*.yml.bak
...
curl -fsSL "https://raw.githubusercontent.com/big-emotion/ferry/v0.5.2/examples/consumer-setup/workflows/ferry-reconcile.yml" \
  -o ".github/workflows/ferry-reconcile.yml"

# Daily cost check — required, runs at 06:00 UTC
curl -fsSL "https://raw.githubusercontent.com/big-emotion/ferry/v0.5.2/examples/consumer-setup/workflows/ferry-cost-daily.yml" \
